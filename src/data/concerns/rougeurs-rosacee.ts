...
export const rougeursRosacee: Concern = {
  ...
  hero: {
    ...
    image: '/images/agence-rosacee-sourire.webp',
  ...
  mechanism: {
    ...
    image: null,
    imageBadge: '',
    imageBrief: 'Macro joue, rougeurs',
    imageDesc: "Gros plan sur des rougeurs diffuses et vaisseaux visibles. Fond neutre chaud, lumière de fenêtre.",
  },
  cohort: {
    image: null,
    imageBrief: 'Avant / après standardisé',
    imageDesc: "Même patiente, même angle 3/4, même distance, même lumière de fenêtre, à S.0 et S.12. Zone traitée toujours visible, jamais masquée.",
  },
  review: {
